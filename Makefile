...
TARGETS = tests/thrdtest tests/heavy tests/shutdown tests/resize \
...
tests/resize: tests/resize.o src/threadpool.o
...
tests/resize.o: tests/resize.c src/threadpool.h
